    ...
    <div className="lg:w-64">
      ...
      >
        ...
        <div>
          ...
          <ul className="mt-3">
            {/* Dashboard */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'home' && 'bg-gray-900'}`}>
              <NavLink exact to="/home" className={`block text-gray-200 hover:text-white transition duration-150 ${page === '' && 'hover:text-gray-200'}`}>
            ...
            {/* Customers */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'loyalty' && 'bg-gray-900'}`}>
              <NavLink exact to="/loyalty" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'customers' && 'hover:text-gray-200'}`}>
                <div className="flex flex-grow">
                  <svg className="flex-shrink-0 h-6 w-6 mr-3" viewBox="0 0 24 24">
            ...
            {/* Orders */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${page === 'store' && 'bg-gray-900'}`}>
              <NavLink exact to="/store" className={`block text-gray-200 hover:text-white transition duration-150 ${page === 'orders' && 'hover:text-gray-200'}`}>
